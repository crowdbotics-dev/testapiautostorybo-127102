...
## Project Structure
    ...
    ├── testapiautostorybo_127102  # Django project configurations
...
1. Clone this repo and `cd testapiautostorybo_127102`
...
2. Clone this repo and `cd testapiautostorybo_127102`
